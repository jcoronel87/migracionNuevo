...
@Local
public interface PlantaBeneficioDao extends GenericDao<PlantaBeneficio, Long> {

    PlantaBeneficio findByPk(Long codigoPlanta);

    PlantaBeneficio findByCodigoArcom(String codigoArcom);
